...
class TOrder extends BaseModel {
  ...
  factory TOrder.fromJson(Map<String, dynamic> json) {
    ...
    return TOrder(
      ...
      rubbleSiteOid: json['rubble_site_oid']?.toString(),
      entryUserOid: json['entry_user_oid']?.toString(),
      processUserOid: json['process_user_oid']?.toString(),
      ...
      driverOid: json['driver_oid']?.toString(),
