...
_dioInterceptor() => dioPackage.InterceptorsWrapper(
  onRequest: (options, handler) {
    String? token = Application.sharedPreferences.getString(
...
final dioPackage.InterceptorsWrapper
dioLoggerInterceptor = dioPackage.InterceptorsWrapper(
...
// الحصول على التوكن
String getToken() {
  String? auth = Application.sharedPreferences.getString(
    Constants.USER_AUTH_TOKEN,
  );
